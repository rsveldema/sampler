...
module nios_sampler_mm_interconnect_0 (
		...
		output wire [11:0] cpu_memory_s1_address,                     //                   cpu_memory_s1.address
		output wire        cpu_memory_s1_write,                       //                                .write
		input  wire [31:0] cpu_memory_s1_readdata,                    //                                .readdata
		output wire [31:0] cpu_memory_s1_writedata,                   //                                .writedata
		output wire [3:0]  cpu_memory_s1_byteenable,                  //                                .byteenable
		output wire        cpu_memory_s1_chipselect,                  //                                .chipselect
		output wire        cpu_memory_s1_clken,                       //                                .clken
	...
	wire   [31:0] cpu_memory_s1_agent_m0_readdata;                                           // cpu_memory_s1_translator:uav_readdata -> cpu_memory_s1_agent:m0_readdata
	wire          cpu_memory_s1_agent_m0_waitrequest;                                        // cpu_memory_s1_translator:uav_waitrequest -> cpu_memory_s1_agent:m0_waitrequest
	wire          cpu_memory_s1_agent_m0_debugaccess;                                        // cpu_memory_s1_agent:m0_debugaccess -> cpu_memory_s1_translator:uav_debugaccess
	wire   [25:0] cpu_memory_s1_agent_m0_address;                                            // cpu_memory_s1_agent:m0_address -> cpu_memory_s1_translator:uav_address
	wire    [3:0] cpu_memory_s1_agent_m0_byteenable;                                         // cpu_memory_s1_agent:m0_byteenable -> cpu_memory_s1_translator:uav_byteenable
	wire          cpu_memory_s1_agent_m0_read;                                               // cpu_memory_s1_agent:m0_read -> cpu_memory_s1_translator:uav_read
	wire          cpu_memory_s1_agent_m0_readdatavalid;                                      // cpu_memory_s1_translator:uav_readdatavalid -> cpu_memory_s1_agent:m0_readdatavalid
	wire          cpu_memory_s1_agent_m0_lock;                                               // cpu_memory_s1_agent:m0_lock -> cpu_memory_s1_translator:uav_lock
	wire   [31:0] cpu_memory_s1_agent_m0_writedata;                                          // cpu_memory_s1_agent:m0_writedata -> cpu_memory_s1_translator:uav_writedata
	wire          cpu_memory_s1_agent_m0_write;                                              // cpu_memory_s1_agent:m0_write -> cpu_memory_s1_translator:uav_write
	wire    [2:0] cpu_memory_s1_agent_m0_burstcount;                                         // cpu_memory_s1_agent:m0_burstcount -> cpu_memory_s1_translator:uav_burstcount
	wire          cpu_memory_s1_agent_rf_source_valid;                                       // cpu_memory_s1_agent:rf_source_valid -> cpu_memory_s1_agent_rsp_fifo:in_valid
	wire  [102:0] cpu_memory_s1_agent_rf_source_data;                                        // cpu_memory_s1_agent:rf_source_data -> cpu_memory_s1_agent_rsp_fifo:in_data
	wire          cpu_memory_s1_agent_rf_source_ready;                                       // cpu_memory_s1_agent_rsp_fifo:in_ready -> cpu_memory_s1_agent:rf_source_ready
	wire          cpu_memory_s1_agent_rf_source_startofpacket;                               // cpu_memory_s1_agent:rf_source_startofpacket -> cpu_memory_s1_agent_rsp_fifo:in_startofpacket
	wire          cpu_memory_s1_agent_rf_source_endofpacket;                                 // cpu_memory_s1_agent:rf_source_endofpacket -> cpu_memory_s1_agent_rsp_fifo:in_endofpacket
	wire          cpu_memory_s1_agent_rsp_fifo_out_valid;                                    // cpu_memory_s1_agent_rsp_fifo:out_valid -> cpu_memory_s1_agent:rf_sink_valid
	wire  [102:0] cpu_memory_s1_agent_rsp_fifo_out_data;                                     // cpu_memory_s1_agent_rsp_fifo:out_data -> cpu_memory_s1_agent:rf_sink_data
	wire          cpu_memory_s1_agent_rsp_fifo_out_ready;                                    // cpu_memory_s1_agent:rf_sink_ready -> cpu_memory_s1_agent_rsp_fifo:out_ready
	wire          cpu_memory_s1_agent_rsp_fifo_out_startofpacket;                            // cpu_memory_s1_agent_rsp_fifo:out_startofpacket -> cpu_memory_s1_agent:rf_sink_startofpacket
	wire          cpu_memory_s1_agent_rsp_fifo_out_endofpacket;                              // cpu_memory_s1_agent_rsp_fifo:out_endofpacket -> cpu_memory_s1_agent:rf_sink_endofpacket
	wire          cmd_mux_002_src_valid;                                                     // cmd_mux_002:src_valid -> cpu_memory_s1_agent:cp_valid
	wire  [101:0] cmd_mux_002_src_data;                                                      // cmd_mux_002:src_data -> cpu_memory_s1_agent:cp_data
	wire          cmd_mux_002_src_ready;                                                     // cpu_memory_s1_agent:cp_ready -> cmd_mux_002:src_ready
	wire    [4:0] cmd_mux_002_src_channel;                                                   // cmd_mux_002:src_channel -> cpu_memory_s1_agent:cp_channel
	wire          cmd_mux_002_src_startofpacket;                                             // cmd_mux_002:src_startofpacket -> cpu_memory_s1_agent:cp_startofpacket
	wire          cmd_mux_002_src_endofpacket;                                               // cmd_mux_002:src_endofpacket -> cpu_memory_s1_agent:cp_endofpacket
	...
	wire          cpu_memory_s1_agent_rp_valid;                                              // cpu_memory_s1_agent:rp_valid -> router_004:sink_valid
	wire  [101:0] cpu_memory_s1_agent_rp_data;                                               // cpu_memory_s1_agent:rp_data -> router_004:sink_data
	wire          cpu_memory_s1_agent_rp_ready;                                              // router_004:sink_ready -> cpu_memory_s1_agent:rp_ready
	wire          cpu_memory_s1_agent_rp_startofpacket;                                      // cpu_memory_s1_agent:rp_startofpacket -> router_004:sink_startofpacket
	wire          cpu_memory_s1_agent_rp_endofpacket;                                        // cpu_memory_s1_agent:rp_endofpacket -> router_004:sink_endofpacket
	...
	wire          cpu_memory_s1_agent_rdata_fifo_src_valid;                                  // cpu_memory_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_002:in_0_valid
	wire   [33:0] cpu_memory_s1_agent_rdata_fifo_src_data;                                   // cpu_memory_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_002:in_0_data
	wire          cpu_memory_s1_agent_rdata_fifo_src_ready;                                  // avalon_st_adapter_002:in_0_ready -> cpu_memory_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_002_out_0_valid;                                         // avalon_st_adapter_002:out_0_valid -> cpu_memory_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_002_out_0_data;                                          // avalon_st_adapter_002:out_0_data -> cpu_memory_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_002_out_0_ready;                                         // cpu_memory_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_002:out_0_ready
	wire    [0:0] avalon_st_adapter_002_out_0_error;                                         // avalon_st_adapter_002:out_0_error -> cpu_memory_s1_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) cpu_memory_s1_translator (
		.clk                    (clk_0_clk_clk),                         //                      clk.clk
		.reset                  (cpu_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (cpu_memory_s1_agent_m0_address),        // avalon_universal_slave_0.address
		.uav_burstcount         (cpu_memory_s1_agent_m0_burstcount),     //                         .burstcount
		.uav_read               (cpu_memory_s1_agent_m0_read),           //                         .read
		.uav_write              (cpu_memory_s1_agent_m0_write),          //                         .write
		.uav_waitrequest        (cpu_memory_s1_agent_m0_waitrequest),    //                         .waitrequest
		.uav_readdatavalid      (cpu_memory_s1_agent_m0_readdatavalid),  //                         .readdatavalid
		.uav_byteenable         (cpu_memory_s1_agent_m0_byteenable),     //                         .byteenable
		.uav_readdata           (cpu_memory_s1_agent_m0_readdata),       //                         .readdata
		.uav_writedata          (cpu_memory_s1_agent_m0_writedata),      //                         .writedata
		.uav_lock               (cpu_memory_s1_agent_m0_lock),           //                         .lock
		.uav_debugaccess        (cpu_memory_s1_agent_m0_debugaccess),    //                         .debugaccess
		.av_address             (cpu_memory_s1_address),                 //      avalon_anti_slave_0.address
		.av_write               (cpu_memory_s1_write),                   //                         .write
		.av_readdata            (cpu_memory_s1_readdata),                //                         .readdata
		.av_writedata           (cpu_memory_s1_writedata),               //                         .writedata
		.av_byteenable          (cpu_memory_s1_byteenable),              //                         .byteenable
		.av_chipselect          (cpu_memory_s1_chipselect),              //                         .chipselect
		.av_clken               (cpu_memory_s1_clken),                   //                         .clken
		.av_read                (),                                      //              (terminated)
		.av_begintransfer       (),                                      //              (terminated)
		.av_beginbursttransfer  (),                                      //              (terminated)
		.av_burstcount          (),                                      //              (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (clk_0_clk_clk),                                  //             clk.clk
		.reset                   (cpu_reset_reset_bridge_in_reset_reset),          //       clk_reset.reset
		.m0_address              (cpu_memory_s1_agent_m0_address),                 //              m0.address
		.m0_burstcount           (cpu_memory_s1_agent_m0_burstcount),              //                .burstcount
		.m0_byteenable           (cpu_memory_s1_agent_m0_byteenable),              //                .byteenable
		.m0_debugaccess          (cpu_memory_s1_agent_m0_debugaccess),             //                .debugaccess
		.m0_lock                 (cpu_memory_s1_agent_m0_lock),                    //                .lock
		.m0_readdata             (cpu_memory_s1_agent_m0_readdata),                //                .readdata
		.m0_readdatavalid        (cpu_memory_s1_agent_m0_readdatavalid),           //                .readdatavalid
		.m0_read                 (cpu_memory_s1_agent_m0_read),                    //                .read
		.m0_waitrequest          (cpu_memory_s1_agent_m0_waitrequest),             //                .waitrequest
		.m0_writedata            (cpu_memory_s1_agent_m0_writedata),               //                .writedata
		.m0_write                (cpu_memory_s1_agent_m0_write),                   //                .write
		.rp_endofpacket          (cpu_memory_s1_agent_rp_endofpacket),             //              rp.endofpacket
		.rp_ready                (cpu_memory_s1_agent_rp_ready),                   //                .ready
		.rp_valid                (cpu_memory_s1_agent_rp_valid),                   //                .valid
		.rp_data                 (cpu_memory_s1_agent_rp_data),                    //                .data
		.rp_startofpacket        (cpu_memory_s1_agent_rp_startofpacket),           //                .startofpacket
		...
		.rf_sink_ready           (cpu_memory_s1_agent_rsp_fifo_out_ready),         //         rf_sink.ready
		.rf_sink_valid           (cpu_memory_s1_agent_rsp_fifo_out_valid),         //                .valid
		.rf_sink_startofpacket   (cpu_memory_s1_agent_rsp_fifo_out_startofpacket), //                .startofpacket
		.rf_sink_endofpacket     (cpu_memory_s1_agent_rsp_fifo_out_endofpacket),   //                .endofpacket
		.rf_sink_data            (cpu_memory_s1_agent_rsp_fifo_out_data),          //                .data
		.rf_source_ready         (cpu_memory_s1_agent_rf_source_ready),            //       rf_source.ready
		.rf_source_valid         (cpu_memory_s1_agent_rf_source_valid),            //                .valid
		.rf_source_startofpacket (cpu_memory_s1_agent_rf_source_startofpacket),    //                .startofpacket
		.rf_source_endofpacket   (cpu_memory_s1_agent_rf_source_endofpacket),      //                .endofpacket
		.rf_source_data          (cpu_memory_s1_agent_rf_source_data),             //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_002_out_0_ready),              // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_002_out_0_valid),              //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_002_out_0_data),               //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_002_out_0_error),              //                .error
		.rdata_fifo_src_ready    (cpu_memory_s1_agent_rdata_fifo_src_ready),       //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (cpu_memory_s1_agent_rdata_fifo_src_valid),       //                .valid
		.rdata_fifo_src_data     (cpu_memory_s1_agent_rdata_fifo_src_data),        //                .data
		.m0_response             (2'b00),                                          //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                            //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) cpu_memory_s1_agent_rsp_fifo (
		.clk               (clk_0_clk_clk),                                  //       clk.clk
		.reset             (cpu_reset_reset_bridge_in_reset_reset),          // clk_reset.reset
		.in_data           (cpu_memory_s1_agent_rf_source_data),             //        in.data
		.in_valid          (cpu_memory_s1_agent_rf_source_valid),            //          .valid
		.in_ready          (cpu_memory_s1_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (cpu_memory_s1_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (cpu_memory_s1_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (cpu_memory_s1_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (cpu_memory_s1_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (cpu_memory_s1_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (cpu_memory_s1_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (cpu_memory_s1_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                          // (terminated)
		.csr_read          (1'b0),                                           // (terminated)
		.csr_write         (1'b0),                                           // (terminated)
		.csr_readdata      (),                                               // (terminated)
	...
	nios_sampler_mm_interconnect_0_router_002 router_004 (
		.sink_ready         (cpu_memory_s1_agent_rp_ready),          //      sink.ready
		.sink_valid         (cpu_memory_s1_agent_rp_valid),          //          .valid
		.sink_data          (cpu_memory_s1_agent_rp_data),           //          .data
		.sink_startofpacket (cpu_memory_s1_agent_rp_startofpacket),  //          .startofpacket
		.sink_endofpacket   (cpu_memory_s1_agent_rp_endofpacket),    //          .endofpacket
		.clk                (clk_0_clk_clk),                         //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_sampler_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                            // in_clk_0.clk
		.in_rst_0_reset (cpu_reset_reset_bridge_in_reset_reset),    // in_rst_0.reset
		.in_0_data      (cpu_memory_s1_agent_rdata_fifo_src_data),  //     in_0.data
		.in_0_valid     (cpu_memory_s1_agent_rdata_fifo_src_valid), //         .valid
		.in_0_ready     (cpu_memory_s1_agent_rdata_fifo_src_ready), //         .ready
	...
	nios_sampler_mm_interconnect_0_avalon_st_adapter_004 #(
		.inBitsPerSymbol (18),
		.inUsePackets    (0),
		.inDataWidth     (18),
		.inChannelWidth  (0),
